...
def wmo_file_download(obs_date):
	...
	#
	url = 'https://dust.aemet.es/thredds/fileServer/dataRoot/MULTI-MODEL/2014/05/20140530_3H_MEDIAN.nc'
...
def main(obs_date, map_region):
	...
	# Check if the graph_path exists
	...
	# Set plot filename
	image_file = graph_path + map_region+'_'+tardate+'.png'
