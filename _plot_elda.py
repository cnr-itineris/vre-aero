...
def main(fromDate, toDate, fromHour, toHour, station, panel, basepath):
    ...
    if panel == '5p':
        ...
        def make_range_consistent(range1, range2, data1, data1_e, data2, data2_e):
            ...
            d1 = data1[0,0,:]; d1_e = data1_e[0,0,:]
            d2 = data2[0,0,:]; d2_e = data2_e[0,0,:]
        ...
        r_355_1064, b0355_RD, b0355_e_RD, b1064_RD, b1064_e_RD = make_range_consistent(height_b0355, height_b1064, b0355, b0355_e, b1064, b1064_e)
        ...
        r_355_532, b0355_RD, b0355_e_RD, b0532_RD, b0532_e_RD = make_range_consistent(height_b0355, height_b0532, b0355, b0355_e, b0532, b0532_e)
        ...
        r_532_1064, b0532_RD, b0532_e_RD, b1064_RD, b1064_e_RD = make_range_consistent(height_b0532, height_b1064, b0532, b0532_e, b1064, b1064_e)
        ...
        r_a_355_532, e0355_RD, e0355_e_RD, e0532_RD, e0532_e_RD = make_range_consistent(height_e0355, height_e0532, e0355, e0355_e, e0532, e0532_e)
...
if __name__ == '__main__':
    if len(sys.argv) < 8 and len(sys.argv) != 7:
        # accept 6 args variant (script-only) and 7 args variant (full call)
        pass
    if len(sys.argv) == 7:
        rc = main(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5], sys.argv[6])
        sys.exit(rc)
    elif len(sys.argv) == 8:
        rc = main(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5], sys.argv[7])
        sys.exit(rc)
    else:
