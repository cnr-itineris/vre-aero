...
"""
 *** Aerosol flow routine ***
 @author: Benedetto De Rosa
 @revision: E. Lapenna
...
# Set variables
data_path = './aeflow/data/'
plot_path = './aeflow/graphs/'
variab_conf = './aeflow/config.yaml'
...
# Ani generator
def generate_ani(cnfg, data_path, plot_path, file_name, target, startdate, enddate, geoarea):
    ...
    if exists(plot_path+output_file):
        os.remove(plot_path+output_file)

    # Save the animation as a GIF file
    ani.save(plot_path+output_file, writer='pillow', fps=8, dpi=300)
...
def parse_args():
    """
    Parses command-line arguments for Aerosol Flow

    Returns:
        argparse.Namespace: Parsed command-line arguments
    """
    parser = argparse.ArgumentParser(description="""
    This utility uses Copernicus Climate data to generate animations of aerosol evolution of a physical variable on a specific area. It is possible to plot a map for Italy, Europe, EuAfAm (Europe-Africa-America) regions. The code produces an animation (webp format) of the evolution of chosen variable in date range set by user.
    Arguments:\n
    ...
    Example usage:\n
        python3 __main__.py --target 1 --startdate 2022-12-01 --enddate 2022-12-03 --geoarea europe --cdsapikey 00000000-0000-0000-0000-000000000000
    """)
...
if __name__ == "__main__":
    ...
    # Generate animation
    ani = generate_ani(cnfg, data_path, plot_path, file_name, args.target, args.startdate, args.enddate, args.geoarea)
