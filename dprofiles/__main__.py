...
# Set paths
data_path = './dprofiles/data/'
plot_path = './dprofiles/graphs/'
...
#
def main(obs_site, obs_date, obs_hour, plot_path):
	...
	mon_file = data_path + "MONARCH_Reanalysis_ec550du_" + monID_list[indx - 1] + "_2006-2016.nc"
	...
	ear_file = data_path + "Dust_Product_" + earID_list[indx - 1] + "_Lev02_DATETIME.nc"
	...
	#
		...
		l_EAR = np.loadtxt(data_path + 'DATASET_L2_' + earID_list[indx - 1] + '532dust_start-202406_list.txt', dtype=str)
		ear_file = data_path + 'desert_dust_prof_prod_collection_2015_2021/desert_dust_prof_prod_' + earID_list[indx - 1] + '_2015_2021/' + l_EAR[inear_DT][0]
...
def parse_args():
	...
	"""
	Parses command-line arguments for Dust Profiles

	Returns:
		argparse.Namespace: Parsed command-line arguments
	"""
	parser = argparse.ArgumentParser(description="""
	This utility plot Desert dust profiling dataset at 532nm obtained at Potenza and Ispra stations between the years 2015 and 2021.
	Arguments:\n
	...
	Example usage:\n
		python3 __main__.py --obs_site POT --obs_date 2015-07-30 --obs_hour 21:00
...
if __name__ == '__main__':
	...
	#
	main(obs_site, obs_date, obs_hour, plot_path)
